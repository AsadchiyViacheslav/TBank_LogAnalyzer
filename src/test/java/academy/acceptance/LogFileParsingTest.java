...
public class LogFileParsingTest {
    ...
    void remoteFileProcessingTest() throws IOException {
        ...
        int exitCode = cmd.execute(
            "-p", "https://raw.githubusercontent.com/elastic/examples/master/Common%20Data%20Formats/nginx_logs/nginx_logs",
            "-f", "json",
            "-o", outputPath
        );
    ...
    void damagedLocalFileProcessingTest() throws IOException {
        String mixedContent = String.join("\n",
            TestUtils.TEST_LOG_LINES[0],
            "invalid log line",
            TestUtils.TEST_LOG_LINES[1]
        );
